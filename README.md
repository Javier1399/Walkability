...
The full analysis pipeline is documented in [`dashboard_walkability.ipynb`](dashboard_walkability.ipynb), designed to run in **Google Colab**. The notebook covers:
